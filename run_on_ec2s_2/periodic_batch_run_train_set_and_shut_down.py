...
import os
log_file = "periodic_run_and_shut_down.log"
    ...
    for which_account in [1,2,3]:
        ...
        for region in regions:
            ...
            for ip, instance_id, ec2_address in zip(public_ips, ids, ec2_addresses):
                ...
                ec2_client_for_shut_down = boto3.client('ec2', region_name=region)
                try:
                    response = ec2_client_for_shut_down.terminate_instances(InstanceIds=[instance_id])
                ...
                # print
                print(instance_id, usage, "shut down")
                with open(log_file, "a") as f:
                    print(instance_id, usage, "shut down", file=f)
            else:
